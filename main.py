...
def run_auto_post_cycle():
    """הלולאה האוטומטית שמפרסמת עם קישור HTML ותצוגת תמונה"""
    ...
    # עיצוב HTML יציב. הקישור הנסתר בראש הפוסט מכריח את טלגרם לפתוח את התמונה באופן אוטומטי
    message_text = (
        f'<a href="{img_url}">&#8205;</a>'
    ...
    try:
        # תיקון קריטי: הוספת parse_mode='HTML' כדי שהקישור יהפוך לכחול והתמונה תיפתח!
