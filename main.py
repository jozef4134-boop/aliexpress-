...
# מאגר הדילים הוויראליים - גרסת טקסט יציבה ללא בגדי נשים
HOT_DEALS_DATABASE = [
    ...
    {"id": "1005006223401948", "title": "תיק גב חכם חסין מים לגברים עם חיבור USB מובנה לטעינה", "price": 68.0, "discount": 40},
    {"id": "1005005510294851", "title": "מכונת תספורת ועיצוב זקן מקצועית לגברים בעיצוב וינטג' מוזהב", "price": 38.0, "discount": 65},
    {"id": "1005006123495811", "title": "מעמד סמארטפון מגנטי חזק במיוחד לרכב - מתאים לכל סוגי המכשירים", "price": 19.5, "discount": 70}
]
...
def run_bot_cycle():
    print("🔄 מתחיל סבב פרסום הודעות טקסט מהמאגר...")
    posted_count = 0
    ...
    for item in HOT_DEALS_DATABASE:
        ...
        if should_post:
            ...
            # עיצוב טקסט נקי, קריא ובטוח ללא תמונות חיצוניות
            message_text = (
            ...
            try:
                # שליחת הודעת טקסט רגילה כדי למנוע חסימות HTTP URL
...
def main_loop():
    print("🚀 הבוט היציב פועל כעת בהצלחה ברקע...")
    try:
        run_bot_cycle()
    except Exception as e:
    ...
    while True:
        # שליחה כל שעתיים בצורה קבועה ומקצועית
        time.sleep(7200)
